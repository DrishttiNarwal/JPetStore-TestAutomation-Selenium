...
//	  
//	  // ---------------Payment Details---------------
//	  // Select card type (drop-down)
//	  new Select(driver.findElement(By.xpath("//*[@id='CenterForm']/form/table[1]/tbody/tr[1]/td[2]/select"))).selectByVisibleText("MasterCard");
//	  
//	  // Enter Card Details
//	  driver.findElement(By.xpath("//*[@id=\"CenterForm\"]/form/table[1]/tbody/tr[2]/td[2]/input")).clear();
//	  driver.findElement(By.xpath("//*[@id=\"CenterForm\"]/form/table[1]/tbody/tr[2]/td[2]/input")).sendKeys("1234567812345678");
//	  pause(500);
//	  
//	  // Expiry Date
//	  driver.findElement(By.xpath("//*[@id=\"CenterForm\"]/form/table[1]/tbody/tr[3]/td[2]/input")).clear();
//	  driver.findElement(By.xpath("//*[@id=\"CenterForm\"]/form/table[1]/tbody/tr[3]/td[2]/input")).sendKeys("12/2030");
//	  pause(500);
//	
//	  // ---------------Billing Address---------------
//	  // First Name
//	  driver.findElement(By.xpath("//*[@id=\"CenterForm\"]/form/table[2]/tbody/tr[1]/td[2]/input")).clear();
//	  driver.findElement(By.xpath("//*[@id=\"CenterForm\"]/form/table[2]/tbody/tr[1]/td[2]/input")).sendKeys("Drishtti");
//	  pause(500);
//	  
//	  // Last Name
//	  driver.findElement(By.xpath("//*[@id=\"CenterForm\"]/form/table[2]/tbody/tr[2]/td[2]/input")).clear();
//	  driver.findElement(By.xpath("//*[@id=\"CenterForm\"]/form/table[2]/tbody/tr[2]/td[2]/input")).sendKeys("Narwal");
//	  pause(500);
//	  
//	  // Address 1
//	  driver.findElement(By.xpath("//*[@id=\"CenterForm\"]/form/table[2]/tbody/tr[3]/td[2]/input")).clear();
//	  driver.findElement(By.xpath("//*[@id=\"CenterForm\"]/form/table[2]/tbody/tr[3]/td[2]/input")).sendKeys("Pashan");
//	  pause(500);
//	  
//	  // Address 2
//	  driver.findElement(By.xpath("//*[@id=\"CenterForm\"]/form/table[2]/tbody/tr[4]/td[2]/input")).clear();
//	  driver.findElement(By.xpath("//*[@id=\"CenterForm\"]/form/table[2]/tbody/tr[4]/td[2]/input")).sendKeys("Baner");
//	  pause(500);
//	  
//	  // City
//	  driver.findElement(By.xpath("//*[@id=\"CenterForm\"]/form/table[2]/tbody/tr[5]/td[2]/input")).clear();
//	  driver.findElement(By.xpath("//*[@id=\"CenterForm\"]/form/table[2]/tbody/tr[5]/td[2]/input")).sendKeys("Pune");
//	  pause(500);
//	  
//	  // State
//	  driver.findElement(By.xpath("//*[@id=\"CenterForm\"]/form/table[2]/tbody/tr[6]/td[2]/input")).clear();
//	  driver.findElement(By.xpath("//*[@id=\"CenterForm\"]/form/table[2]/tbody/tr[6]/td[2]/input")).sendKeys("Maharashtra");
//	  pause(500);
//	  
//	  // Zip 
//	  driver.findElement(By.xpath("//*[@id=\"CenterForm\"]/form/table[2]/tbody/tr[7]/td[2]/input")).clear();
//	  driver.findElement(By.xpath("//*[@id=\"CenterForm\"]/form/table[2]/tbody/tr[7]/td[2]/input")).sendKeys("411009");
//	  pause(500);
//	  
//	  // Country
//	  driver.findElement(By.xpath("//*[@id=\"CenterForm\"]/form/table[2]/tbody/tr[8]/td[2]/input")).clear();
//	  driver.findElement(By.xpath("//*[@id=\"CenterForm\"]/form/table[2]/tbody/tr[8]/td[2]/input")).sendKeys("India");
//	  pause(500);
//	  
//	  // Continue ahead
